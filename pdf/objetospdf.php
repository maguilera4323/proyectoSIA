...
//Iniciando un nuevo pdf
        ...
        $pdf->Cell(35,6,'TIPO DE OBJETO',1,1,'C',1); 
        ...
        while ($dataRow = mysqli_fetch_array($query)) {
                ...
                $pdf->Cell(38,15,$dataRow['objeto'],1,0,'C');
                $pdf->Cell(110,15, $dataRow['descripcion'],1,0,'C');
                $pdf->Cell(35,15, $dataRow['tipo_objeto'],1,1,'C');
            }
