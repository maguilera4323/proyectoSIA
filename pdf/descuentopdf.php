...
//Iniciando un nuevo pdf
        ...
        $pdf->Cell(70,6,'PORCENTAJE',1,1,'C',1); 
        ...
        // filtro de cliente
        $filtrodescuento=($_POST['filtrodescuento']);

        $sqlTrabajadores = ("SELECT * FROM TBL_descuentos WHERE nom_descuento LIKE'%".$filtrodescuento."%'");
        ...
        while ($dataRow = mysqli_fetch_array($query)) {
                $pdf->Cell(90,6,($dataRow['nom_descuento']),1,0,'C');
                $pdf->Cell(70,6, $dataRow['porcentaje_descuento']*100,1,1,'C',);
        ...
        $pdf->Output('Resumen_Descuentos_'.date('d_m_y').'.pdf', 'I'); 
