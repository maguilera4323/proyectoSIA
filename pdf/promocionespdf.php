...
//Iniciando un nuevo pdf
        ...
        $pdf->Cell(103,6,'LISTA DE PROMOCIONES',0,0,'C');
        ...
        $pdf->Cell(34,6,'FECHA DE INICIO',1,0,'C',1);
        $pdf->Cell(27,6,'FECHA FINAL',1,0,'C',1);
        $pdf->Cell(39,6,'ESTADO PROMOCION',1,0,'C',1);
        $pdf->Cell(39,6,'PRECIO PROMOCION',1,1,'C',1); 
        ...
        while ($dataRow = mysqli_fetch_array($query)) {
                $pdf->Cell(38,6,($dataRow['nom_promocion']),1,0,'C');
                $pdf->Cell(34,6,($dataRow['fech_ini_promo']),1,0,'C');
                $pdf->Cell(27,6,($dataRow['fech_fin_promo']),1,0,'C');
                $pdf->Cell(39,6,($dataRow['id_estado_promocio']),1,0,'C');
                $pdf->Cell(39,6, $dataRow['precio_promocion'],1,1,'C',);
        ...
        $pdf->Output('Resumen_Promociones_'.date('d_m_y').'.pdf', 'I'); 
