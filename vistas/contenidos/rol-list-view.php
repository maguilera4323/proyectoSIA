...
<div class="container-fluid">
<form class="d-flex" action="../pdf/rolespdf.php" method="post" accept-charset="utf-8">		
		<input class="form-control me-2 light-table-filter" data-table="table_id" type="text" name="filtroroles"
		placeholder="Buscar Roles"> <div class="row">
					<div class="col">
