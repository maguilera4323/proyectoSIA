...
<p><?php 
				...
				$ins_descuentos=new descuentosControlador();
					...
					//instancia para obtener los datos ya guardados en la tabla de descuentos
					//para realizar los cambios de un registro
					$datos_descuento=$ins_descuentos->datosdescuentosControlador("unico",$id_editar);

					if($datos_descuento->rowCount()==1){
						$campos=$datos_descuento->fetch();
					}
				?></p>
	<div class="container-fluid">
